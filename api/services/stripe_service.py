...
def create_checkout_session(user_id: UUID, price_id: str, base_url: str, user_email: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        logger.info(f"Created checkout session for user {user_id} | Request ID: {getattr(g, 'request_id', None)}")
        ...
        logger.error(f"Stripe error in create_checkout_session: {str(e)} | Request ID: {getattr(g, 'request_id', None)}")
        return {
            "success": False,
            "error": {
                "type": "StripeError",
        ...
        logger.error(f"Unexpected error in create_checkout_session: {str(e)} | Request ID: {getattr(g, 'request_id', None)}")
        return {
            "success": False,
            "error": {
                "type": "InternalError",
...
def verify_payment_and_update_subscription(user_id: UUID, session_id: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if update_result:
            logger.info(f"Updated subscription status for user {user_id} | Request ID: {getattr(g, 'request_id', None)}")
            ...
            logger.error(f"Failed to update subscription status for user {user_id} | Request ID: {getattr(g, 'request_id', None)}")
            return {
                "success": False,
                "error": {
                    "type": "DatabaseError",
        ...
        logger.error(f"Stripe error in verify_payment_and_update_subscription: {str(e)} | Request ID: {getattr(g, 'request_id', None)}")
        return {
            "success": False,
            "error": {
                "type": "StripeError",
        ...
        logger.error(f"Unexpected error in verify_payment_and_update_subscription: {str(e)} | Request ID: {getattr(g, 'request_id', None)}")
        return {
            "success": False,
            "error": {
                "type": "InternalError",
...
def get_user_subscription_status(user_id: UUID) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"Error getting subscription status: {str(e)} | Request ID: {getattr(g, 'request_id', None)}")
        return {
            "success": False,
            "error": {
                "type": "InternalError",
