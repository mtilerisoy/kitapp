...
def register_stripe_routes(app):
    ...
    def create_checkout_session():
        ...
        try:
            ...
            if result["success"]:
                return (
                    jsonify(
                        {"sessionId": result["sessionId"], "request_id": g.request_id}
                    ),
                    200,
                )
            else:
            ...
            logger.error(
                f"Unexpected error in create_checkout_session route: {str(e)} | Request ID: {g.request_id}"
            )
            return (
                jsonify(
                    {
    ...
    def verify_payment():
        ...
        try:
            ...
            logger.error(
                f"Unexpected error in verify_payment route: {str(e)} | Request ID: {g.request_id}"
            )
            return (
                jsonify(
                    {
    ...
    def get_subscription_status():
        ...
        try:
            ...
            logger.error(
                f"Unexpected error in get_subscription_status route: {str(e)} | Request ID: {g.request_id}"
            )
            return (
                jsonify(
                    {
