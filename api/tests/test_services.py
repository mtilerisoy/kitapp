...
@patch('api.services.book_service.get_supabase_client', side_effect=Exception('RPC error'))
...
@patch('api.services.categories_service.get_supabase_client', side_effect=Exception('DB error'))
@patch('api.services.categories_service.Categories')
